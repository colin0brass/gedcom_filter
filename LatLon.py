"""
LatLon.py - LatLon class for GEDCOM mapping.

Defines the LatLon class for representing and validating latitude/longitude coordinates.
Used by Location and other geocoding utilities.
